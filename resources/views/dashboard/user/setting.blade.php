                                ...
                                <div class="nk-block-head nk-block-head-lg">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            <h4 class="nk-block-title">Edit Info</h4>
                                        </div>
                                                ...
                                                <form action="{{ route('user.updateProfile') }}" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input type="text" name="name" value="{{ old('name', optional($user)->name) }}" class="form-control" id="full-name">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="form-label" for="email-address">Email</label>
                                                        <div class="form-control-wrap">
                                                            <input type="email" name="email" value="{{ old('email', optional($user)->email) }}" class="form-control" id="email-address">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="form-label" for="email-address">Phone</label>
                                                        <div class="form-control-wrap">
                                                            <input type="tel" name="phone" value="{{ old('phone', optional($user)->phone) }}" class="form-control" id="email-address">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="form-label" for="email-address">Date Of Birth</label>
                                                        <div class="form-control-wrap">
                                                            <input type="date" name="date_of_birth" value="{{ old('date_of_birth', optional($user)->date_of_birth) }}" class="form-control" id="email-address">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input type="text" name="address" value="{{ old('address', optional($user)->address) }}" class="form-control" id="email-address">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="form-label" for="email-address">State</label>
                                                        <div class="form-control-wrap">
                                                            <input type="text" name="state" value="{{ old('state', optional($user)->state) }}" class="form-control" id="email-address">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                ...
                                <div class="card-inner-group" data-simplebar="init"><div class="simplebar-wrapper" style="margin: 0px;"><div class="simplebar-height-auto-observer-wrapper"><div class="simplebar-height-auto-observer"></div></div><div class="simplebar-mask"><div class="simplebar-offset" style="right: 0px; bottom: 0px;"><div class="simplebar-content-wrapper" tabindex="0" role="region" aria-label="scrollable content" style="height: auto; overflow: hidden;"><div class="simplebar-content" style="padding: 0px;">
                                                        ...
                                                        <div class="card-inner p-0">
                                                            <ul class="link-list-menu">
                                                                ...
                                                                <li><a class="active" href="{{ route('user.setting') }}"><em class="icon ni ni-setting"></em><span>Account Settings</span></a></li>
